    ...
    >
      ...
      <div
        ...
        style={{
          ...
          background: `
            linear-gradient(115deg, rgb(80 40 120), rgb(30 15 50)),
            radial-gradient(90% 100% at calc(50% + var(--posX)*1px) calc(0% + var(--posY)*1px), rgb(140 70 180), rgb(60 30 100)),
            radial-gradient(100% 100% at calc(80% - var(--posX)*1px) calc(0% - var(--posY)*1px), rgb(180 80 220), rgb(70 25 120)),
            radial-gradient(150% 210% at calc(100% + var(--posX)*1px) calc(0% + var(--posY)*1px), rgb(120 50 200), rgb(90 40 150)),
            radial-gradient(100% 100% at calc(100% - var(--posX)*1px) calc(30% - var(--posY)*1px), rgb(200 100 240), rgb(100 50 160)),
            linear-gradient(60deg, rgb(110 40 150), rgb(150 70 200))
          `,
          backgroundBlendMode:
